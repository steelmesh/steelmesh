...
function _getPackageFolder(packageFile, callback) {
    ...
    metafs.remove(versionFolder, function(rmErr) {
        metafs.mkdir_p(versionFolder, function(mkErr) {
            if (mkErr) {
                throw new Error('Unable to create package folder: ' + versionFolder);
            }
