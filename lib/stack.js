...
function loadJobs(config, stack) {
    stack.log('looking for job files in: ' + config.pathJobs);
...
function NodeStack() {
    this.config = {
        ...
        couchdb_db: 'tripplanner', // 'stackdata'
        
        // default pgsql connection string
        pgUrl: 'tcp://postgres:1234@localhost/geostack', // 'stackdata',
...
NodeStack.prototype.validateDesign = function(typeName, design, callback) {
